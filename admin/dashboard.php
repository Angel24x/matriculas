     ...
     <div class="card text-white bg-primary mb-3">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="float-sm-right text-dark">&nbsp;<span style="font-size: 30px"><?php $stu=mysqli_query($db_con,'SELECT * FROM `student_info`'); $stu= mysqli_num_rows($stu); echo $stu; ?></span></div>
            <div class="clearfix"></div>
            <div class="float-sm-right text-dark">Total de Estudiantes</div>
          </div>
        </div>
      </div>
     ...
     <div class="card text-white bg-info mb-3">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="float-sm-right text-dark">&nbsp;<span style="font-size: 30px"><?php $tusers=mysqli_query($db_con,'SELECT * FROM `users`'); $tusers= mysqli_num_rows($tusers); echo $tusers; ?></span></div>
            <div class="clearfix"></div>
            <div class="float-sm-right text-dark">Total de Usuarios</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div style="font-size: 20px" class='text-dark'><?php echo ucwords($userrow['name']); ?></div>
          </div>
          <div class="col-sm-6">
            
            <div class="clearfix"></div>
            <div class="float-sm-right text-dark">Bienvenidos</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
