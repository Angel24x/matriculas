...
<title>
    ...
    Matrícula de Estudiantes</title>
    
  </head>
  
  <body>
  <br><br>
  <h1 class="text-center">Matrícula de Estudiantes</h1><br>
  
    <br><br>
  
  <center><img src="Escudo.png" width="230" height="300"></center>
    <div class="container"><br>
      <center><a class="btn btn-primary float-right" href="admin/login.php">Panel Administrativo</a><br><br></center>
          ...
          <div class="row">
            ...
            <table class="text-center infotable">
              ...
              <tr>
                ...
                <td>
                   <select class="form-control" name="choose">
                     ...
                     <option value="Primero A">
                       Primero A
                     </option>
                     <option value="Primero B">
                       Primero B
                     </option>
                     <option value="Segundo A">
                       Segundo A
                     </option>
                     <option value="Segundo B">
                       Segundo B
                     </option>
                     <option value="Tercero A">
                       Tercero A
                     </option>
                     <option value="Tercero B">
                       Tercero B
                     </option>
                     <option value="Cuarto A">
                       Cuarto A
                     </option>
                     <option value="Cuarto B">
                       Cuarto B
                     </option>
                     <option value="Quinto A">
                       Quinto A
                       <option value="Quinto B">
                       Quinto B
                       </option>
                       <option value="Sexto A">
                       Sexto A
                     </option>
                     <option value="Sexto B">
                       Sexto B
                     </option>
                   </select>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input class="form-control" type="text" pattern="[0-9]{8}" id="roll" placeholder="8 dígitos..." name="roll">
                </td>
              </tr>
              <tr>
